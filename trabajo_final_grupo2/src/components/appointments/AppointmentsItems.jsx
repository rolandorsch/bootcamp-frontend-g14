...
const AppointmentsItems = ({ datos, onRemove , recargarDatos,lastIndex,firstIndex  }) => {
        ...
        return (
          <tbody>
            ...
            >
              ...
              <td>{cita.sintomas}</td>
              <td>
               <Registrarcita datos={cita}  recargarDatos={recargarDatos}/> 
                {/* <input
              ...
              <td>
                ...
                >
                 ...
                 <Registrarcita datos={''} recargarDatos={recargarDatos}/> 
                {/* <input
                  className="border p-2 bg-red-800 text-white rounded-md cursor-pointer"
                  type="submit"
                  value="Editar Modal"
